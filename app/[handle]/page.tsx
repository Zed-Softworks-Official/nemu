...
export default async function ArtistPage({params}: { params: { handle: string}}) {
    ...
    return (
        <div>
            <div className="mx-auto max-w-[130rem] lg:max-w-[100rem] h-96 bg-[url('/curved0.jpg')] rounded-3xl bg-no-repeat bg-center bg-cover">
            </div>
            <div className="mx-auto max-w-[120rem] lg:max-w-[90rem] -my-28 py-14 backdrop-blur-xl bg-fullwhite/60 shadow-lg rounded-3xl px-10">

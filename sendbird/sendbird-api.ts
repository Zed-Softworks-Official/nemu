import { SendbirdChannelData, SendbirdUserData } from './sendbird-structures'
...
export class SendbirdAPI {
     ...
     * @param data 
     */
    private async BasePOSTRequest(request_path: 'users' | 'group_channels', data: SendbirdUserData | SendbirdChannelData) {
